				...
				<div class="container-fluid">
					...
					<div>
						...
						<div class="card shadow mb-4">
							...
							<div class="card-body">
								<form id="jsonUpload">
									<input type="file" id="jsonFile" name="jsonFile" accept="*"
										multiple>
									<hr>
									<button type="button" onclick="jsonUpload();"
						...
						<div class="card shadow mb-4">
							<div class="card-header py-3">
								<h6 class="m-0 font-weight-bold text-primary">강의 프로그램 Excel
									파일 업로드</h6>
							</div>
							<div class="card-body">
								<form id="xlsxUpload">
									<input type="file" id="xlsxFile" name="xlsxFile" accept="*"
										multiple>
									<hr>
									<button type="button" onclick="xlsxUpload();"
										class="btn btn-primary btn-icon-split" style="float: left;">
										<span class="icon text-white-50"> <i
											class="fas fa-check"></i>
										</span> <span class="text">업로드</span>
						...
						<div class="card shadow mb-4">
							...
							<div class="card-body">
								<form id="wavUpload">
									<input type="file" id="wavFile" name="wavFile" accept="*"
										multiple>
									<hr>
									<button type="button" onclick="wavUpload();"
										class="btn btn-primary btn-icon-split" style="float: left;">
										<span class="icon text-white-50"> <i
											class="fas fa-check"></i>
										</span> <span class="text">업로드</span>
