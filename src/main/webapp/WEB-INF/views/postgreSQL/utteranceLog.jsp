            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-2 text-gray-800">
                        <b>문장 수정 이력 관리</b>
                        <span style="font-size:18px;">총 ${totalCount}건</span>
                        <c:if test="${searchResult != '전체'}">
                            <a onclick="utteranceAll()"
                               style="color: #006fdd; cursor: pointer; font-size:0.6em;">전체보기</a>
                        </c:if>
                    </h1>
                </div>
...
<script>
function utteranceAll(){
    location.href =  '${pageContext.request.contextPath}/getUtteranceLog?data='+ $('#show_data_type').val() + '&current_page_no=1&count_per_page=10&count_per_list=10&search_word=';
}
</script>
</body>
