...
$(function(){
	...
	const barData1 = [
	    {name: '1분 이내', value: barData1List[0], color: '#5487b1'},
	    {name: '1분~2분', value: barData1List[1], color: '#63a1af'},
	    {name: '2분~3분', value: barData1List[2], color: '#7ab8aa'},
	    {name: '3분~4분', value: barData1List[3], color: '#93caa8'},
	    {name: '4분~5분', value: barData1List[4], color: '#add7a8'},
	    {name: '5분 이상', value: barData1List[5], color: '#c6e3a7'}
	  ];
...
function getCountListOnJsonLog(){
	$.ajax({
		//요청
		type: "GET",
		url: contextPath + "/chart/getCountListOnJsonLog", 
		async: false,
