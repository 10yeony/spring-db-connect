...
}],illegal:/\S/}}})());hljs.registerLanguage("pgsql",(()=>{"use strict";return E=>{
...
contains:a,keywords:e,illegal:"\\S"}}})());hljs.registerLanguage("htmlbars",(()=>{"use strict";function e(e){
...
t}})());hljs.registerLanguage("php-template",(()=>{"use strict";return n=>({
...
},i,e.QUOTE_STRING_MODE,e.APOS_STRING_MODE,r,e.CSS_NUMBER_MODE]}]}}})());hljs.registerLanguage("django",(()=>{"use strict";return e=>{const t={
...
className:"template-variable",begin:/\{\{/,end:/\}\}/,contains:[t]}]}}})());hljs.registerLanguage("shell",(()=>{"use strict";return s=>({
