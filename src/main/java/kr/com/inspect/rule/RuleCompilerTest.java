...
public class RuleCompilerTest {
    ...
    public Object runObject(Rule rule) throws Exception{
        ...
        // 메소드 가져오기
        Method objMethod = cls.getDeclaredConstructor().newInstance().getClass().getMethod("start");
        // 메서드 실행
    ...
    private String getSource(Rule rule){
        ...
        sb.append("package kr.com.inspect.rule;\n" +
                ...
                "import java.util.List;\n\n" +
                "public class "+rule.getFile_name()+" extends Thread {\n")
