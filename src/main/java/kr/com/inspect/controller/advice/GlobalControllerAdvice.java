 ...
 * handleNoHandlerFoundException(HttpServletRequest request) {
 * request.setAttribute("errorMsg", "존재하지 않는 페이지입니다."); return "/error"; }
 * 
 *//**
	 ...
	 *//*
		 ...
		 * handleDefaultException(HttpServletRequest request, Exception e) {
		 * request.setAttribute("errorMsg", "페이지 처리에 문제가 발생하였습니다."); return "/error"; }
		 * }
		 */