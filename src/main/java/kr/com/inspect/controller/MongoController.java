...
public class MongoController {
	 ...
	 * @return string 엘라스틱서치에서 받아온 인덱스 데이터를 몽고DB 컬렉션에 입력하는 페이지로 이동
	 */
	 ...
	 * @param model
	 * @return string 해당되는 collection 데이터를 볼 수 있는 페이지를 리턴
	 */
	 ...
	 * @param request
	 * @return string MongoDB에 JSON 데이터를 입력하는 페이지를 리턴
	 */
